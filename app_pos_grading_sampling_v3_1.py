...
class Frame1(tk.Frame):
    def __init__(self, master):
        ...
        self.logo_image = tk.PhotoImage(file="Logo-CBI(4).png")  # Replace "logo.png" with your image file path
        ...
        self.logo_image2 = tk.PhotoImage(file="LOGO-SRS(1).png")
    ...
    def update_row(self, row_item, line_txt):
        ...
        if row_id not in self.clicked_buttons and not self.running_script:
            ...
            thread = threading.Thread(target=self.run_script, args=(row_item, row_id, row_values, line_txt))
            thread.start()

    def run_script(self, row_item, row_id, row_values, line_txt):
        
        plat_est = row_values[0]
        
        try:

            script_output = os.popen('sh /home/grading/script_generate_pdf_app_pos_grading_v2.sh').read()
